...
var someone = (name: "Monday", age: 25)
 ...
 */
// write your code here
print("\(someone.0) is \(someone.1) year old")
 ...
 */
// No you will not be able to change a constant value becasue it is a constant 
